...
INSERT INTO ADM_Usuarios (id_usuario, usuario, password, fec_mod) VALUES (1, 'root', 'pwd', CAST('2015-12-23 00:00:00.000' AS DateTime))
INSERT INTO ADM_Usuarios (id_usuario, usuario, password, fec_mod) VALUES (28, 'test', 'pwd', CAST('2012-06-18 22:34:09.000' AS DateTime))
INSERT INTO ADM_Usuarios (id_usuario, usuario, password, fec_mod) VALUES (30, 'usuario_prueba', 'pwd', CAST('2015-12-23 16:54:50.493' AS DateTime))
